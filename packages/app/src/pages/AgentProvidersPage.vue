 ...
 * original trigger : open the providers panel
 * URL              : http://localhost:5173/agents/providers
 */
...
<template>
  <StubPage title="Provider profiles" :tabs="agentsCatalogTabs()" selected="providers" />
