 ...
 * original trigger : open the skills / capabilities panel
 * URL              : http://localhost:5173/agents/capabilities
 */
...
<template>
  <StubPage title="Capability catalog" :tabs="agentsCatalogTabs()" selected="capabilities" />
