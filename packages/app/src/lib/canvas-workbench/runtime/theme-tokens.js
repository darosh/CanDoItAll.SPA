...
export function readTokens(hostValue, tokenMap) {
...
export function watchTheme(hostValue, onChange) {
  const host = requireElement(hostValue, "host");
...
export function readThemeMode(hostValue) {
...
export function watchThemeMode(hostValue, dotNetRef, methodName) {
