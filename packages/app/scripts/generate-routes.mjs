...
const routes = [
  ...
  ["workspace", "/projects/:projectId", "Details", "ProjectDetailPage"],
  ["workspace", "/projects/:projectId/structure", "Structure", "ProjectStructurePage"],
  ["workspace", "/projects/:projectId/gantt", "Gantt", "ProjectGanttPage"],
  ["workspace", "/projects/:projectId/files", "Files", "ProjectFilesPage"],
  [
    "workspace",
  ...
  ["workspace", "/projects/:projectId/processes", "Processes", "ProjectProcessesPage"],
  [
    "workspace",
  ...
  ["workspace", "/projects/:projectId/calendar", "Calendar", "ProjectCalendarPage"],
  ...
  ["workspace", "/crm-hr/workforce/:partyId", "Profile", "CrmWorkforceProfilePage"],
  ...
  ["workspace", "/crm-hr/agents", "Business agents", "CrmAgentsPage"],
  ["workspace", "/crm-hr/agents/:partyId", "Business agent detail", "CrmAgentDetailPage"],
  ...
  ["library", "/memory", "Memory providers", "MemoryProvidersPage"],
  ["library", "/memory/:memoryId", "Memory provider overview", "MemoryProviderOverviewPage"],
  [
    "library",
    "/memory/:memoryId/operations",
    "Memory provider operations",
    "MemoryProviderOperationsPage",
  ],
  ["library", "/memory/:memoryId/events", "Memory provider events", "MemoryProviderEventsPage"],
  [
    "library",
    "/memory/:memoryId/feedback",
    "Memory provider feedback",
    "MemoryProviderFeedbackPage",
  ],
  ["library", "/memory/:memoryId/query", "Memory provider query", "MemoryProviderQueryPage"],
  [
    "library",
    "/memory/:memoryId/ingestion",
    "Memory provider ingestion",
    "MemoryProviderIngestionPage",
  ],
  ["library", "/memory/:memoryId/provider-ui", "Memory provider UI", "MemoryProviderUiPage"],
