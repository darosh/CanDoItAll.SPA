...
- Total routes: 76 (15 built, 61 stub)
- Journey starting points (sidebar nav entries, from `nav.ts`): 18
- Orphaned pages (no start point, nothing opens them): 2
- Original (.NET) `@page` routes not yet referenced by any page header: 8
...
| /memory                                   | src/Modules/CanDoItAll.Modules.Memory/Pages/MemoryProvidersPage.razor     |
