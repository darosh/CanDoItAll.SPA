...
| [/processes/runs/:runId](http://localhost:5173/processes/runs/:runId)                             |             | execution  | Process run detail              |                                                                                                                                                                                                                                  | /processes/runs, /projects/:projectId/processes/runs | [ProcessRunDetailPage.vue](src/pages/ProcessRunDetailPage.vue)                                         | stub   | http://localhost:5032/processes/live                     | select a run                                                                 |
...
| [/projects/:projectId](http://localhost:5173/projects/:projectId)                                 |             | workspace  | Project overview                | /projects/:projectId/calendar, /projects/:projectId/files, /projects/:projectId/gantt, /projects/:projectId/manager-summary, /projects/:projectId/processes, /projects/:projectId/processes/runs, /projects/:projectId/structure | /projects                                            | [projects/ProjectOverviewPage.vue](src/pages/projects/ProjectOverviewPage.vue)                         | built  | http://localhost:5032/projects                           | select a project from the list                                               |
| [/projects/:projectId/calendar](http://localhost:5173/projects/:projectId/calendar)               |             | workspace  | Project calendar                |                                                                                                                                                                                                                                  | /projects/:projectId                                 | [ProjectCalendarPage.vue](src/pages/ProjectCalendarPage.vue)                                           | stub   | http://localhost:5032/projects/:projectId/calendar       |                                                                              |
...
| [/projects/:projectId/manager-summary](http://localhost:5173/projects/:projectId/manager-summary) |             | workspace  | Project manager summary         |                                                                                                                                                                                                                                  | /projects/:projectId                                 | [ProjectManagementPage.vue](src/pages/ProjectManagementPage.vue)                                       | stub   | http://localhost:5032/:projectId/structure               | select the Manager Summary tab                                               |
| [/projects/:projectId/processes](http://localhost:5173/projects/:projectId/processes)             |             | workspace  | Project processes               | /projects/:projectId/processes/runs                                                                                                                                                                                              | /projects/:projectId                                 | [ProjectProcessesPage.vue](src/pages/ProjectProcessesPage.vue)                                         | stub   | http://localhost:5032/projects/:projectId/processes      |                                                                              |
| [/projects/:projectId/processes/runs](http://localhost:5173/projects/:projectId/processes/runs)   |             | workspace  | Project process runs            | /processes/runs/:runId                                                                                                                                                                                                           | /projects/:projectId, /projects/:projectId/processes | [ProjectProcessRunsPage.vue](src/pages/ProjectProcessRunsPage.vue)                                     | stub   | http://localhost:5032/projects/:projectId/processes/live | select the Live Processes tab within Processes                               |
...
| [/projects/new](http://localhost:5173/projects/new)                                               |             | hand-built | New project                     |                                                                                                                                                                                                                                  | /projects                                            | [projects/ProjectNewPage.vue](src/pages/projects/ProjectNewPage.vue)                                   | built  | http://localhost:5032/projects                           | click "New project"                                                          |
...
| [/settings/api-access](http://localhost:5173/settings/api-access)                                 |             | hand-built | API access                      |                                                                                                                                                                                                                                  | /settings                                            | [SettingsApiAccessPage.vue](src/pages/SettingsApiAccessPage.vue)                                       | built  | http://localhost:5032/settings                           | click the API access tab                                                     |
...
| [/settings/database](http://localhost:5173/settings/database)                                     |             | settings   | Database profiles               |                                                                                                                                                                                                                                  | /settings                                            | [SettingsDatabasePage.vue](src/pages/SettingsDatabasePage.vue)                                         | stub   | http://localhost:5032/                                   | open the database flyout from the shell's bottom utility bar (any page)      |
...
| [/settings/runtime-capabilities](http://localhost:5173/settings/runtime-capabilities)             |             | hand-built | Runtime capabilities            |                                                                                                                                                                                                                                  | /settings                                            | [settings/SettingsRuntimeCapabilitiesPage.vue](src/pages/settings/SettingsRuntimeCapabilitiesPage.vue) | built  | http://localhost:5032/settings/runtime-capabilities      |                                                                              |
...
| [/workflows/:workflowId/runs](http://localhost:5173/workflows/:workflowId/runs)                   |             | execution  | Workflow runs (single workflow) | /workflows/runs/:runId                                                                                                                                                                                                           | /workflows/:workflowId                               | [WorkflowRunsForWorkflowPage.vue](src/pages/WorkflowRunsForWorkflowPage.vue)                           | stub   | http://localhost:5032/agents/workflows                   | click the History tab for a specific workflow                                |
...
| [/workflows/runs/:runId](http://localhost:5173/workflows/runs/:runId)                             |             | execution  | Workflow run detail             |                                                                                                                                                                                                                                  | /workflows/:workflowId/runs, /workflows/runs         | [WorkflowRunDetailPage.vue](src/pages/WorkflowRunDetailPage.vue)                                       | stub   | http://localhost:5032/agents/workflows                   | click the History tab, then select a run                                     |
...
flowchart LR
  ...
  projects-projectId-calendar["/projects/:projectId/calendar"]
  projects-projectId-files["/projects/:projectId/files"]
  projects-projectId-gantt["/projects/:projectId/gantt"]
  projects-projectId-manager-summary["/projects/:projectId/manager-summary"]
  projects-projectId-processes["/projects/:projectId/processes"]
  projects-projectId-processes-runs["/projects/:projectId/processes/runs"]
  ...
  projects-projectId --> projects-projectId-calendar
  projects-projectId --> projects-projectId-files
  projects-projectId --> projects-projectId-gantt
  projects-projectId --> projects-projectId-manager-summary
  projects-projectId --> projects-projectId-processes
  projects-projectId --> projects-projectId-processes-runs
  projects-projectId --> projects-projectId-structure
  projects-projectId-processes --> projects-projectId-processes-runs
  projects-projectId-processes-runs --> processes-runs-runId
...
flowchart LR
  ...
  workflows-workflowId-runs --> workflows-runs-runId
